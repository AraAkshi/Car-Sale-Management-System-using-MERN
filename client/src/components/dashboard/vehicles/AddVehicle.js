...
import { addSaleVehicle } from '../../../actions/saleVehicle';
import PropTypes from 'prop-types';
import { Link } from 'react-router-dom';
import Alerts from '../../layout/Alerts';
import SideNavbar from '../SideNavbar';

const SaleAddVehicle = ({ addSaleVehicle, history }) => {
...
SaleAddVehicle.propTypes = {
  addSaleVehicle: PropTypes.func.isRequired,
};

export default connect(null, { addSaleVehicle })(withRouter(SaleAddVehicle));
