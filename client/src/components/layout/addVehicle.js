...
const Register = ({ setAlert, register, isAuthenticated }) => {
  ...
  const onSubmit = async e => {
    ...
    register({ name, nic, email, address, contact, password });
  };
};
  ...
  <Fragment>
    ...
    <form className='form' onSubmit={e => onSubmit(e)}>
      ...
      <div className='form-group'>
        ...
        />
        <small className='form-text'>
          Please enter a password of minimum length of 6 characters including at
          least one uppercase character and a number
        </small>
      </div>
      <div className='form-group'>
        <input
